...
(cl:defmethod cl:initialize-instance :after ((m <PointArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PointArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name wifi_exploration-msg:<PointArray> is deprecated: use wifi_exploration-msg:PointArray instead.")))
